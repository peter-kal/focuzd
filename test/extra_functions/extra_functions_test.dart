...
void main() {
  group('extra functions test', () {
    ...
    test('test endsOn', () {
      ...
      final whenTimerRuns = ExtraFunctions().endsOn(
          300,
          TimerRunInProgress(200, 2, 1, 4, '200', 0, '0', [], 'focus', 1000,
              200, DateTime.now().add(Duration(seconds: 300))),
          fixedTime);
      final whenInitial =
          ExtraFunctions().endsOn(300, TimerInitial(300, 1, 4), fixedTime);
      final whenPause = ExtraFunctions().endsOn(
          300,
          TimerRunPause(300, 1, 1, 4, 300, '0', '0', [], 'focus', 1000, 200,
